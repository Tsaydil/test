...
const Client = require('../classes/Client1');
const ChatManager = require('../classes/ChatManager1');
const {getChatObj}  = require('../../index');



function getTokenSlack (app, url) {
